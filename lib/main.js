...
var uaPanel = panels.Panel({
  	...
  	contentScriptFile: [data.url('js/jquery-1.8.2.min.js'),
		...
		if(data != 'focus'){
			if(data != null && data != ''){
					if(data.match(/^default/gi) || data.match(/^firefox/gi)){
						...
						var safariUA = "Mozilla/5.0 (Macintosh; Intel Mac OS X 1081) AppleWebKit/536.25 (KHTML like Gecko) Version/6.0 Safari/536.25 ";
...
// safari 5.0.5 UA
var safari = cm.Item({ label: "Safari 6", data: "Mozilla/5.0 (Macintosh; Intel Mac OS X 1081) AppleWebKit/536.25 (KHTML like Gecko) Version/6.0 Safari/536.25 " });
