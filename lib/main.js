		...
		if(data != 'focus'){
			if(data != null && data != ''){
					if(data == "default"){
						...
						prefs.set("general.useragent.override","Mozilla/5.0 (iPhone; U; CPU iPhone OS 4_0 like Mac OS X; en-us) AppleWebKit/532.9 (KHTML, like Gecko) Version/4.0.5 Mobile/8A293 Safari/6531.22.7");
					}else if (data == "android"){
						prefs.set("general.useragent.override","Mozilla/5.0 (Linux; U; Android 2.2; en-us; Nexus One Build/FRF91) AppleWebKit/533.1 (KHTML, like Gecko) Version/4.0 Mobile Safari/533.1");
					}else{
